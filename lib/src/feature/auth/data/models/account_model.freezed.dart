...
mixin _$AccountModel {
 ...
 String get uniqueName; String? get token;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AccountModel&&(identical(other.uniqueName, uniqueName) || other.uniqueName == uniqueName)&&(identical(other.token, token) || other.token == token));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uniqueName,token);

@override
String toString() {
  return 'AccountModel(uniqueName: $uniqueName, token: $token)';
}
...
@useResult
$Res call({
 String uniqueName, String? token
});
...
/// Create a copy of AccountModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uniqueName = null,Object? token = freezed,}) {
  return _then(_self.copyWith(
uniqueName: null == uniqueName ? _self.uniqueName : uniqueName // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uniqueName,  String? token)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.uniqueName,_that.token);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uniqueName,  String? token)  $default,) {final _that = this;
switch (_that) {
case _AccountModel():
return $default(_that.uniqueName,_that.token);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uniqueName,  String? token)?  $default,) {final _that = this;
switch (_that) {
case _AccountModel() when $default != null:
return $default(_that.uniqueName,_that.token);case _:
  return null;
...
class _AccountModel extends AccountModel {
  const _AccountModel({required this.uniqueName, this.token}): super._();
  factory _AccountModel.fromJson(Map<String, dynamic> json) => _$AccountModelFromJson(json);

@override final  String uniqueName;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AccountModel&&(identical(other.uniqueName, uniqueName) || other.uniqueName == uniqueName)&&(identical(other.token, token) || other.token == token));
}
...
/// Create a copy of AccountModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uniqueName = null,Object? token = freezed,}) {

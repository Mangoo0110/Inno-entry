...
import 'package:inno_entry/src/feature/auth/domain/entities/login_params.dart';
import 'package:inno_entry/src/feature/auth/domain/repo/auth_repo.dart';

final class UnlockAccount implements AsyncUsecase<AuthStatus, LoginParams> {
  const UnlockAccount(this._repo);

  final AuthRepo _repo;

  @override
  AsyncRequest<AuthStatus> call(LoginParams params) {
